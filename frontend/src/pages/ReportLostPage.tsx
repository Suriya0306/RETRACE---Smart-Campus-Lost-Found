...
import { FilePlus, Sparkles, Upload, Image as ImageIcon, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 py-10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xs space-y-8">
          ...
          {/* Section 3: Image Upload & Contact */}
          <div className="space-y-4">
            <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider pb-2 border-b border-slate-100 flex items-center gap-2">
              <span className="w-6 h-6 rounded-md bg-blue-100 text-blue-700 text-xs flex items-center justify-center">3</span>
              Image Upload & Contact
            </h3>

            {/* Image File Upload Component */}
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5">Upload Lost Item Photo</label>
              <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border border-dashed border-slate-300 rounded-2xl bg-slate-50/50">
                ...
                <div className="space-y-2 text-xs flex-1 w-full">
                  <div>
                    <label className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold text-xs border border-blue-200 cursor-pointer transition-colors">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2 rounded-lg border border-slate-200 text-xs bg-white focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
              </div>
